...
Route::prefix('v1')->group(function () {
    Route::middleware(['auth:techysavvy', ApiTenancyMiddleware::class])->group(function () {
        ...
        Route::get('projects/{project:slug}', [ProjectController::class, 'show'])->name('api.v1.orgs.projects.show');
        Route::patch('projects/{project:slug}', [ProjectController::class, 'update'])->name('api.v1.orgs.projects.update');
        Route::delete('projects/{project:slug}', [ProjectController::class, 'destroy'])->name('api.v1.orgs.projects.destroy');

        Route::get('projects/{project:slug}/archived', [ArchiveController::class, 'index'])->name('api.v1.orgs.projects.archived.index');
        Route::post('projects/{project:slug}/archive', [ArchiveController::class, 'archive'])->name('api.v1.orgs.projects.archive');
        Route::post('projects/{project:slug}/restore', [ArchiveController::class, 'restore'])->name('api.v1.orgs.projects.restore');
        Route::get('projects/{project:slug}/activity', [ActivityLogController::class, 'projects'])->name('api.v1.orgs.projects.activity.index');
        ...
        Route::group([
            ...
            Route::scopeBindings()->group(function () {
                ...
                Route::get('tasks/{task:key}', [TaskController::class, 'show'])->name('api.v1.orgs.projects.tasks.show');
                Route::patch('tasks/{task:key}', [TaskController::class, 'update'])->name('api.v1.orgs.projects.tasks.update');
                Route::delete('tasks/{task:key}', [TaskController::class, 'destroy'])->name('api.v1.orgs.projects.tasks.destroy');
                Route::get('tasks/{task:key}/activity', [ActivityLogController::class, 'tasks'])->name('api.v1.orgs.projects.tasks.activity.index');

                Route::group([
                    'prefix' => 'tasks/{task:key}',
                ], function () {
